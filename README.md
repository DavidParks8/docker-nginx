...
Docker Hub
----------
The trusted build information can be found on the Docker Hub at https://registry.hub.docker.com/u/davidparks8/nginx-static/.
...
```dockerfile
# Guide here:
# https://github.com/DavidParks8/docker-nginx
